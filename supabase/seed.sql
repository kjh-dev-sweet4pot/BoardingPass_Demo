-- Mock seed for minimal schema (4 tables)
-- Run AFTER schema.sql

delete from public.allocations where visit_code like 'MOCK-%';
delete from public.influencers where instagram_handle_normalized in (
  'mina_beauty', 'soyeon.daily', 'jay_style', 'yuna_looks', 'haneul_pick'
);
delete from public.products where sku like 'MOCK-%';
delete from public.stores where name like '목업%';
...
insert into public.influencers (id, name, instagram_handle, notes) values
  ('33333333-3333-3333-3333-333333333301', '김미나', '@mina_beauty', '뷰티 · 팔로워 12만'),
  ('33333333-3333-3333-3333-333333333302', '박소연', '@soyeon.daily', '라이프스타일'),
  ('33333333-3333-3333-3333-333333333303', '이재윤', '@jay_style', '패션'),
  ('33333333-3333-3333-3333-333333333304', '최유나', '@yuna_looks', '메이크업'),
  ('33333333-3333-3333-3333-333333333305', '정하늘', '@haneul_pick', '스킨케어 리뷰');
